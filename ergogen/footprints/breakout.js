...
const PINS = [
  ...
  // (P0.03/06/07/08/09/10/11/13 moved to the diode matrix + encoder btn)
  ['P0.14', 'GP_P0_14'], ['P0.15', 'GP_P0_15'], ['P0.16', 'GP_P0_16'],
  ['P0.19', 'GP_P0_19'], ['P0.21', 'GP_P0_21'], ['P0.23', 'GP_P0_23'],
  ['P0.24', 'GP_P0_24'], ['P0.25', 'GP_P0_25'], ['P0.00', 'GP_P0_00'],
  ['P0.01', 'GP_P0_01'],
